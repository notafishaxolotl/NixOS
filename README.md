...
- And make sure to replace my username (acito) with your own in [configuration.nix](nixos/configuration.nix) []() [flake.nix](.dotfiles/flake.nix) [home.nix](.dotfiles/home.nix)
